...
public class MainCoursesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ListView mainCoursesList = findViewById(R.id.list_view_main_courses);

        final Dish[] mainCourses = {
        ...
        final ArrayAdapter<Dish> dishAdapter = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1, mainCourses);
